...
state sampleAcons(){
	...
	st.hands.push_back(cardcons(dy,4));
	st.hands.push_back(cardcons(hjys,4));
	st.hands.push_back(cardcons(hjys,3));
	st.hands.push_back(cardcons(ljfs,2));
	st.hands.push_back(cardcons(jb,0));
	st.fields.clear();
	st.auras=emptyau;
	st.mana=5;
...
state sampleCcons(){
	...
	//st.hands.push_back(cardcons(hjys,4));
	st.fields.clear();
	//st.fields.push_back(minioncons(mhrlq));
	st.auras=emptyau;
	//st.auras.ahrlq=2;
	st.mana=6;
	st.num=0;
...
state sampleEcons(){
	state st;
	st.hands.clear();
	st.hands.push_back(cardcons(ayb,1));
	st.hands.push_back(cardcons(ayb,1));
	st.hands.push_back(cardcons(hrlq,1));
	st.hands.push_back(cardcons(dy,1));
	st.hands.push_back(cardcons(tw,1));
	st.hands.push_back(cardcons(syzl,1));
	st.hands.push_back(cardcons(glfz,1));
	st.hands.push_back(cardcons(glfz,1));
	st.hands.push_back(cardcons(sjdf,1));
